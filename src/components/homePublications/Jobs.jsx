      ...
      <section className={style.container1}>
        <div className={style.container2}>
          ...
          <div className={style.news}>
            ...
            <p>{description}</p>
            <p>
              <span className={style.llavePost}><svg width="23px" height="23px" strokeWidth="1.73" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffcc02"><path d="M17 22H7a2 2 0 01-2-2v-8.818a.6.6 0 00-.1-.333L3.1 8.15a.6.6 0 01-.1-.333V2.6a.6.6 0 01.6-.6h1.8a.6.6 0 01.6.6v1.8a.6.6 0 00.6.6h2.8a.6.6 0 00.6-.6V2.6a.6.6 0 01.6-.6h2.8a.6.6 0 01.6.6v1.8a.6.6 0 00.6.6h2.8a.6.6 0 00.6-.6V2.6a.6.6 0 01.6-.6h1.8a.6.6 0 01.6.6v5.218a.6.6 0 01-.1.333l-1.8 2.698a.6.6 0 00-.1.333V20a2 2 0 01-2 2z" stroke="#ffcc02" strokeWidth="1.73"></path></svg>&nbsp;</span> {company}
            </p>
            <p>
              <span className={style.llavePost}><svg width="23px" height="23px" strokeWidth="1.73" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffcc02"><path d="M20 10c0 4.418-8 12-8 12s-8-7.582-8-12a8 8 0 1116 0z" stroke="#ffcc02" strokeWidth="1.73"></path><path d="M12 11a1 1 0 100-2 1 1 0 000 2z" fill="#ffcc02" stroke="#ffcc02" strokeWidth="1.73" strokeLinecap="round" strokeLinejoin="round"></path></svg>&nbsp;</span> {place}
            </p>
            <p>
              <span className={style.llavePost}><svg width="23px" height="23px" strokeWidth="1.73" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffcc02"><path d="M7 4v1M7 9v1M17 20V4m0 0l3 3m-3-3l-3 3M7 14v6m0 0l3-3m-3 3l-3-3" stroke="#ffcc02" strokeWidth="1.73" strokeLinecap="round" strokeLinejoin="round"></path></svg>&nbsp;</span>{" "}
              {modality}
            </p>
            <p>
              <span className={style.llavePost}><svg width="23px" height="23px" strokeWidth="1.73" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffcc02"><path d="M16.154 7.154c-.949-.949-2.619-1.608-4.154-1.65m-4.154 10.65c.893 1.19 2.552 1.868 4.154 1.926m0-12.576c-1.826-.049-3.461.778-3.461 3.034 0 4.154 7.615 2.077 7.615 6.231 0 2.37-2.027 3.387-4.154 3.31m0-12.575V3m0 15.08V21" stroke="#ffcc02" strokeWidth="1.73" strokeLinecap="round" strokeLinejoin="round"></path></svg>&nbsp;</span> {salary}
            </p>
            <p>
              <span className={style.llavePost}><svg width="23px" height="23px" strokeWidth="1.73" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffcc02"><path d="M18.118 14.702L14 15.5c-2.782-1.396-4.5-3-5.5-5.5l.77-4.13L7.815 2H4.064c-1.128 0-2.016.932-1.847 2.047.42 2.783 1.66 7.83 5.283 11.453 3.805 3.805 9.286 5.456 12.302 6.113 1.165.253 2.198-.655 2.198-1.848v-3.584l-3.882-1.479z" stroke="#ffcc02" strokeWidth="1.73" strokeLinecap="round" strokeLinejoin="round"></path></svg>&nbsp;</span> {contact}
            </p>
